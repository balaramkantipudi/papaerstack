            ...
            {currentIntegration?.status === "connected" ? (
              ...
              <Card className="ambient-shadow">
                <CardBody className="p-6">
                  ...
                  <div className="flex flex-col items-center justify-center p-12 border border-dashed border-foreground-300 rounded-lg mb-6">
                    <Icon icon="lucide:plug" className="h-16 w-16 text-foreground-300 mb-4" />
                    <h3 className="font-dmsans font-semibold text-xl mb-2">Connect to {currentIntegration?.name}</h3>
                    <p className="text-foreground-500 text-center mb-6 max-w-md">
