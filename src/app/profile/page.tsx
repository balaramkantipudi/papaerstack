                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          {isEditing ? (
                            ...
                            <p className="text-foreground-900">{email}</p>
                          )}
                          <div className="ml-2 bg-success-100 text-success-600 text-xs px-2 py-0.5 rounded-full flex items-center">
        ...
        {activeTab === "company" && (
          ...
          >
            ...
            <Card className="ambient-shadow">
              <CardBody className="p-6">
                <h2 className="font-gilroy text-xl font-bold mb-6">Team Members</h2>
                
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 hover:bg-foreground-50 rounded-md transition-colors">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-foreground-200 mr-4"></div>
                      <div>
                        <p className="font-medium">John Contractor</p>
                        <p className="text-sm text-foreground-500">Project Manager • Admin</p>
                      </div>
                    </div>
                    <div className="bg-primary-100 text-primary-600 text-xs px-2 py-0.5 rounded-full">
                      You
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-foreground-50 rounded-md transition-colors">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-foreground-500">Operations Director • Admin</p>
                      </div>
                    </div>
                    <Button
                      size="sm"
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-foreground-50 rounded-md transition-colors">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-foreground-200 mr-4"></div>
                      <div>
                        <p className="font-medium">Mike Builder</p>
                        <p className="text-sm text-foreground-500">Site Supervisor • Member</p>
                      </div>
                    </div>
                    <Button
                      size="sm"
